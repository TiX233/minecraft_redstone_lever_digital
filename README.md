...
本项目主要基于 PY32F002B 进行实现，通过自己设计的红石通信协议来在一个通信周期为所有红石元件内传递所有红石信号，具体的红石通信协议可以在 [红石线代码仓库](https://gitee.com/TiX233/minecraft_redstone_wire_digital) 的 readme 文件中看到详细描述，此处不赘述
